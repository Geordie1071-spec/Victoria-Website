...
export default function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div className="relative z-20 text-center px-4 max-w-5xl" style={{ y, opacity }}>
        ...
        >
          <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 2, repeat: Infinity }} className="text-white">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
              <path d="M15 5L15 20M15 20L10 15M15 20L20 15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </motion.div>
        </motion.div>
      </motion.div>
